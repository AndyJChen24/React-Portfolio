    ...
    return(
        <div class="container">
            <div class="row">
                ...
                <div class="col col-md-12 col-sm-12 col-xs-12 col-lg-8">
                    <h1>Contact</h1>
                    ...
                    <div class="row">
                        <a target="_blank" href="https://www.linkedin.com/in/andy-j-chen/"><i class="fa fa-linkedin"></i> https://www.linkedin.com/in/andy-j-chen/</a>
                    </div>
                </div>
            </div>
        </div>
